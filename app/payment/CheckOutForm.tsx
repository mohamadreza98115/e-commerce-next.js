...
export default function CheckoutForm() {
    const countries = Countries.getNames('en', {select: 'all'});
                        ...
                        <TabPanel value="card" className="p-0">
                            <form className="mt-12 flex flex-col gap-4">
                                <div>
                                    ...
                                    <Input type="email" label="Email Address" crossOrigin={'auto'}/>
                                </div>
                                ...
                                <div className="my-6">
                                    ...
                                    <div className="my-4 flex items-center gap-4">
                                        <Input
                                            ...
                                            containerProps={{className: "min-w-[72px]"}} crossOrigin={'auto'}/>
                                        <Input
                                            label="CVC"
                                            maxLength={4}
                                            containerProps={{className: "min-w-[72px]"}} crossOrigin={'auto'}/>
                                    </div>
                                    <Input label="Holder Name" crossOrigin={'auto'}/>
                                </div>
                        ...
                        <TabPanel value="paypal" className="p-0">
                            <form className="mt-12 flex flex-col gap-4">
                                ...
                                <div className="my-6">
                                    ...
                                    <Input
                                        label="Postal Code"
                                        containerProps={{className: "mt-4"}} crossOrigin={'auto'}/>
                                </div>
